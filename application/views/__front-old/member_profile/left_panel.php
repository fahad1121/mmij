                                    ...
                                    <div class="row">
                                        ...
                                        foreach ($gallery_data as $value) {
                                            if (file_exists('uploads/gallery_image/'.$value['image']) && strlen($value['image']) > 0) {
                                                ...
                                                <?php
                                            } else if (file_exists('video/'.$value['video'].'.mp4') && strlen($value['video']) > 0)
                                            {
                                                $has_video = 1;
                                                ?>
                                                <div class="col-sm-4 mt-4">
                            ...
                            <div class="row">
                                <div class="stats-entry col-md-6" style="width: 100%">
                                    <span class="stats-label text-uppercase changeStatus"
                                          data-id= <?= $get_member[0]->member_id ?>>BLOCK</span>
                                </div>
                                <div class="vl"></div>
                                <div class="stats-entry col-md-5" style="width: 100%">
                                        <span class="stats-label text-uppercase interestStatus"
                                              data-id= <?= $get_member[0]->member_id ?>>INTERESTED</span>
                                </div>
                            </div>
                        </div>

                        <a style="color:#000;box-shadow:none;" class="<?=$message_class?>" id="message_a_<?=$get_member[0]->member_id?>" <?php if ($message_onclick == 1){	?>onclick="return confirm_message(	<?=$get_member[0]->member_id?>)"<?php 	} elseif ($message_onclick == 0){		?>onclick="profile_load('messaging',<?php echo $if_message->message_thread_id?>);"<?php	}	?>>
...
<script>
    ...
    window.location.href = "<?=base_url()?>home/chat/"+id;

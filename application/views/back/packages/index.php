<?php 
	//echo "<pre>";
    //print_r($all_plans[1]->plan_id);exit; 
?>
<!--CONTENT CONTAINER-->
<!--===================================================-->
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php foreach ($all_plans as $value): ?>
					        ...
					        <div class="panel panel-colorful panel-dark">
					            <div class="panel-body">
									<div class="text-center" style="margin-top: 22px;">
										...
										<p style="font-size: 25px"><b><?=currency('','def').$value->monthly_amount?></b></p>
										<p><?php echo translate('express_interest:')?> <?=$value->express_interest?></p>
										<p><?php echo translate('direct_messages:')?> <?=$value->direct_messages?></p>
					...
					<?php endif ?>
					<?php if ($value->plan_id != 1 && $value->plan_id != 3): ?>
						<div class="col-sm-4 col-lg-3">
					        <!--Primary Panel-->
					        <!--===================================================-->
					        <div class="panel panel-bordered-primary">
					            <div class="panel-body">
					            	...
					            	<div class="text-center">
										...
										?>
										<h3 class="panel-title"><?=$value->name?></h3>
										<p style="font-size: 25px">Monthly: <b><?=currency('', 'def')?><?=$value->monthly_amount?></b></p>
										<p style="font-size: 25px">Quarterly: <b><?=currency('', 'def')?><?=$value->quaterly_amount?></b></p>
										<p style="font-size: 25px">Bi annually: <b><?=currency('', 'def')?><?=$value->bi_annually_amount?></b></p>
										<p style="font-size: 25px">Annually: <b><?=currency('', 'def')?><?=$value->yearly_amount?></b></p>
										<p><?php echo translate('express_interest:')?> <?=$value->express_interest?></p>
										<p><?php echo translate('direct_messages:')?> <?=$value->direct_messages?></p>
										<p><?php echo translate('photo_gallery:')?> <?=$value->photo_gallery?> <?php echo translate('images')?></p>
					            	</div>

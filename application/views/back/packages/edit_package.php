        ...
        <div class="row">
			...
			<form class="form-horizontal" id="package_form" method="POST" action="<?=base_url()?>admin/packages/update" enctype="multipart/form-data">
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="demo-hor-amount"><b>Amount (Monthly)</b></label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><?=currency('', 'def')?></div>
								<input type="text" class="form-control" name="monthly_amount" required="" value="<?=$value->monthly_amount?>">
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="demo-hor-amount"><b>Amount (Quaterly)</b></label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><?=currency('', 'def')?></div>
								<input type="text" class="form-control" name="quaterly_amount" required="" value="<?=$value->quaterly_amount?>">
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="demo-hor-amount"><b>Amount (Bi Annually)</b></label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><?=currency('', 'def')?></div>
								<input type="text" class="form-control" name="bi_annually_amount" required="" value="<?=$value->bi_annually_amount?>">
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="demo-hor-amount"><b>Amount (Yearly)</b></label>
						<div class="col-sm-9">
							<div class="input-group">
								<div class="input-group-addon"><?=currency('', 'def')?></div>
								<input type="text" class="form-control" name="yearly_amount" required="" value="<?=$value->yearly_amount?>">
							</div>
						</div>
					</div>
					<!-- <div class="form-group">
				...
				<input type="hidden" name="paypalQuarterlyPlanId" value="<?=$quarterlyPlan->product?>">
				<input type="hidden" name="paypalBiannualPlanId" value="<?=$biAnnualPlan->product?>">
				<input type="hidden" name="paypalAnnualPlanId" value="<?=$annualPlan->product?>">

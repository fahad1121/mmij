...
<html>
    ...
    <body>
        ...
        <section class="has-bg-cover bg-size-cover" style="background-image: url(<?=base_url()?>uploads/login_image/<?=$login_image_data[0]['image']?>); background-position: bottom bottom; padding-top: 4rem; padding-bottom: 4rem;"">
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-6" style="font-size: 12px;">
                                            <div class="checkbox">
                                                ...
                                                <label for="remember_me"><span class="font_light"><?php echo translate('remember_me')?></span></label>
                                            </div>
                                        </div>
                                        <div class="col-6 text-right" style="font-size: 12px;">
                                            <a href="<?=base_url()?>home/forget_pass" class="font_light"><?php echo translate('recover_password')?></a>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
                                    <div class="col-12 text-center" style="font-size: 12px;">
                                        <span class="font_light"><?php echo translate('new_here?')?></span><a class="font_light" href="<?=base_url()?>home/registration"> <u><?php echo translate('create_an_account_from_here!')?></u></a>
                                    </div>
                                </div>
                            </div>
                        </div>

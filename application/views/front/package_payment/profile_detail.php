...
//																							echo $this->Crud_model->select_html('yes_no', 'do_i_fast', 'name', 'edit', 'form-control form-control-sm selectpicker', $astronomic_information_data[0]['do_i_fast'], '', '', '');
						...
						<script>
							function check_form()
							{
								...
								{
									showAlert = false;
									$("#emailVerificationAlert").text("Email verification still not completed. Please check your inbox")
								}
								...
								if (introduction_empty != false && basicInfo_empty != false && physical_empty != false && astronomic_empty  != false && emailStatus != 0)
								{

				...
				<div class="d-flex f-col">
					...
					<div class="p-2 flex-fill w-30">
						<div class="form-group mb-2 mx-sm-2">
							<input type="text" class="form-control form-control-sm" name="member_id" id="filter_member_id" value="<?php if (isset($member_id)) {echo $member_id;} ?>" placeholder="MEMBER ID">
						</div>
					</div>
					<div class="p-2 flex-fill w-30">
						<div class="form-group mb-2">

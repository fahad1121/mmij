...
<section class="slice sct-color-1">
	<div class="container clearfix" style=" max-width: 1600px!important;">
		<div class="row">
			<div class="col" style="padding-left: 0px !important;">
				...
				if ($advance_search_position == 'center') {
					include_once 'filter.php';

				?>
			</div>
			<div class="col-md-12 col-xl-12 clearfix">
			...
			<!-- <div id="pagination" style="margin-left: 50% !important;margin-top: 10px;">
...
<section class="sct-color-1 m-2 clearfix">

<section class="slice sct-color-1">
	...
	<div class="container">
		...
		<div class="" style=" color: black;">
			...
			<br /><br />
			<b>Always Use Your Best Judgment</b>
			<br /><br />
			...
			<ol>
				<li>
					If you ask basic specific questions, and their answers are always unclear.</li>
				<li>If they want you to depositing funds, shipping merchandise, etc).</li>
				<li>If they want to know your where about, your address, schedule, friends.</li>
				<li>If they tell stories that are inconsistent or grandiose stories.</li>
				<li>If they talk and ask inappropriate questions.</li>
				<li>If they suddenly have a personal crisis and pressures you to provide financial assistance, and their demand starts to get increasingly aggressive.</li>
				<li>If they start pressuring you to marry him/her right away, even though you insist, you need more time.</li>
				<li>If they say that they live in the U.S. but are currently living, working, or traveling abroad.</li>
				<li>If they ask you for any financial help, or materialistic need.</li>
				<li>If they are very anxious to talk or chat on an outside email or messaging service.</li>
				<li>If someone was recently widowed, and are already looking for someone.</li>
				<li>If someone suddenly disappears from site under one name, then reappears under a different name.</li>
				<li>If someone insists on getting overly close, very fast.</li>
				<li>If someone has a negative attitude majority of the time, someone who always blames others for troubles in his or her life.</li>
				<li>If a match does any of the above activities or makes you suspicious in any way, please report this as a Match Concern by emailing to matchmadeinjannah@concerns.com so that we can investigate the matter. </li>
			</ol>
			<b>NEVER - Share Financial Info. or Any Personal Info.</b>
			<br /><br />
			<ul>
				<li>DO NOT give out your credit card number or bank information.</li>
				<li>DO NOT send money to someone you meet online, especially by wire transfer.</li>
				<li>DO NOT share your Social Security Number, mother's maiden name, or other private information that can be used to access your financial information.</li>
			</ul>
			...
			<br /><br />
			<b>Protect Your Account Always</b>
			<br /><br />
			...
			<br /><br />
			<b>
				Never Share Personal Information</b>
			<br /><br />
			...
			<br /><br />
			<b>Please Research for Yourself</b>
			<br /><br />
			...
			<ol>
				<li>Type your match's name into a search engine</li>
				<li>Contact your state or local municipalities to obtain public information</li>
				<li>Type your match's name into a search engineUse a paid service to obtain a full background report.</li>
			</ol>
			...
			<br /><br />
			<b>Use Caution Before Clicking on Any URL Link</b>
			<br /><br />
			...
			<br /><br />
			<b>Make Your First Meeting Safe & Successful</b>
			<br /><br />
			...
			ALWAYS:
			<ol>
				<li>Inform elders in your home of the Match Made In Jannah connection, if you find someone who seems like a good connection.</li>
				<li>Communication is of the utmost importance, talk to him/her on regular basis. Feel comfortable & get to know your match well, before you decide to introduce to your family</li>
				<li>When someone wants to meet you, make sure that his/her intentions are good.</li>
				<li>Always dress appropriately, remember, you want someone to like and accept you as a husband/wife</li>
			</ol>
			<br />
			<b>Respectful and Kindness</b>
			<br /><br />
			...
			<br /><br />
			<b>Report Concerns About a Match Made In Jannah</b>
			<br /><br />

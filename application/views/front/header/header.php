				...
				<div class="st-content-inner">
							...
							<div class="container navbar-container">
								...
								<div class="collapse navbar-collapse align-items-center justify-content-end" id="navbar_main">
									...
									<ul class="navbar-nav" data-hover="dropdown">
										...
										<li class="custom-nav dropdown dropdown--style-2 dropdown--animated" id="">
											<a class="dropdown-icon dropdown-toggle has-notification" href="#" data-toggle=""
												aria-expanded="false">
												<span class="u-badge-v1 g-rounded-50x d-none" id="msgCount"></span>
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-scale" id="message_list" style="max-height: 300px;overflow: auto;">
											</div>
										</li>
					...
					<div class="sticky-content">
						...
						function show_msgList() {
							$.ajax({
								type: "POST",
								url: "<?= base_url() ?>messaging/show_msg_list",
								cache: false,
						...
						function show_msgCount() {
							$.ajax({
								type: "POST",
								url: "<?= base_url() ?>messaging/msg_count",
								cache: false,
								success: function(response) {
									if(response != '') {
										$("#msgCount").html(response).removeClass('d-none');
									}else {
										$("#msgCount").html('').addClass('d-none');
									}
								}
							});
						}

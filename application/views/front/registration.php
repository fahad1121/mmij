...
<html>
    <head>
        ...
        <?php
            ...
            echo "<script> var isloggedin = "; echo $this->session->userdata('member_id') == null ? 'false' : 'true'; echo ";</script>";
        ?>
                        ...
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
                                <div class="text-center px-2">
                                    <h4 class="heading heading-4 strong-400 mb-4 font_light"><?=translate('register')?></h4>
                                </div>
                                
                                <?php if($this->session->flashdata('alert')): ?>
                                <div class="alert alert-success alert-dismissible fade show mt-4" role="alert">
                                <p class="text-center"><strong>Registration Successful!</strong> </p>
                                <p class="text-center"><?php echo $this->session->flashdata('alert') ?></p>
                                ...
                                <form class="form-default mt-4" id="register_form" method="post" action="<?=base_url()?>home/registration/add_info">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo translate('username')?></label>
                                                <input type="text" class="form-control form-control-sm" name="username" value="<?php if(!empty($form_contents)){echo $form_contents['username'];}?>" autofocus>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-1 col-12">
                                        ...
                                        <small class="font_light"><?=translate('I_agree_to_Match_Made_In_Jannah')?> <a href="<?=base_url()?>home/terms_and_conditions" class="font_light"><u><?=translate('terms_and_conditions')?></u></a> and <a href="<?=base_url()?>home/privacy_policy" class="font_light"><u>Privacy Policy</u></a></small>

<footer id="footer" class="footer">
	<div class="footer-top" style="padding-top: 1rem; padding-bottom: 0rem;">
		<div style="padding-left: 10%; padding-right: 10%;">
			<div class="row cols-xs-space cols-sm-space cols-md-space">
				<?php $footer_logo_info = $this->db->get_where('frontend_settings', array('type' => 'footer_logo'))->row()->value;
				...
				if ($footer_logo_position == 'left') {                                            ?>
					<div class="col-md-3 col-lg-3" style="text-align: left;line-height: 1;padding-left: 5px !important;padding-right: 5px !important;">
						<div class="col" style="padding-left: 2px !important;padding-right: 2px !important;">
							...
							<small style="line-height: 0.5rem;padding: 0.25rem 0;font-size: 0.8rem;font-weight: 400;">Match Made In Jannah<br />1950 S. Rochester Rd. #1102<br />Rochester Hills, MI 48037<br />(248) 934-0075</small>
						</div>
					</div>
				<?php                                            }                                        ?>
				<div class="col-md-3 col-lg-3" style="text-align: left;line-height: 1;padding-left: 5px !important;padding-right: 5px !important;">
				...
				<div class="col-md-3 col-lg-3" style="text-align: left;line-height: 1;padding-left: 5px !important;padding-right: 5px !important;">
					<div class="col" style="padding-left: 2px !important;padding-right: 2px !important;">
						...
						<ul class="footer-links" style="line-height: 0.5rem;">
							...
							<li> <a href="<?= base_url() ?>home/warning" title="FAQ"> Warnings and Suspension </a> </li>
							<li>
				...
				<?php                                            }                                        ?>
				<div class="row col-md-12 col-lg-12" style="margin-left:0px !important; padding: 0px !important">
					
						<div class="col-md col-sm col-lg-3" style="padding: 8px !important;">
							<small style="line-height: 0.5rem;padding: 0.25rem 0;font-size: 0.8rem;font-weight: 400;">customers@matchmadeinjannah.com</small>
						</div>
						<div class="col-md col-sm col-lg-3 text-lg-center" style="padding: 8px !important;">
							<small style="line-height: 0.5rem;padding: 0.25rem 0;font-size: 0.8rem;font-weight: 400;">techelp@matchmadeinjannah.com</small>
						</div>
						<div class="col-md col-sm col-lg-3 text-lg-right" style="padding: 8px !important;">
							<small style="line-height: 0.5rem;padding: 0.25rem 0;font-size: 0.8rem;font-weight: 400;">success@matchmadeinjannah.com</small>
						</div>

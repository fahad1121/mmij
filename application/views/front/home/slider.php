    ...
    <div style="position: relative;">
        ...
        <div class="container pl-0">
            <div class="slider_header">
                ...
                <!--<div class="feature feature--boxed-border feature--bg-1 z-depth-2-bottom animated animation-ended s-search" data-animation-in="zoomIn" data-animation-delay="400" style="background: #1b1e23b3; padding: 0.5em;">-->
        ...
        <!--                        <div class="form-group has-feedback">-->
        <!--                            <label for="" class="text-uppercase text-white">Age</label>-->
        <!--                            <?= $this->Crud_model->select_html('age_range', 'age_range', 'name', 'edit', 'form-control form-control-sm selectpicker present_state_edit', '', '', '', ''); ?>-->
        ...
        <!--                    <div class="col-lg-2 col-md-2 col-sm-6 col-6">-->
        <!--                        <div class="form-group has-feedback">-->
        <!--                            <label for="" class="text-uppercase text-white">Country</label>-->
        <!--                            <?= $this->Crud_model->select_html('country', 'country', 'name', 'edit', 'form-control form-control-sm selectpicker present_state_edit', '', '', '', ''); ?>-->
        <!--                            <div class="help-block with-errors">-->
        <!--                            </div>-->
        <!--                        </div>-->
        <!--                    </div>-->
        ...
        <!--                    <div class="col-lg-2 col-md-2 col-sm-6 col-6">-->
        <!--                        <div class="form-group has-feedback">-->
        <!--                            <label for="" class="text-uppercase text-white">Profession</label>-->

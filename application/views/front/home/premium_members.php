<section class="slice sct-color-1" style="padding-bottom: 0rem !important;padding-top:  0.5rem !important;">
    <div class="container">
        <div class="section-title section-title--style-1 text-center" style="margin-bottom: 0rem !important;">
            ...
            <span><b>PLATINUM MEMBERS</b></span>
            </h3>
                                    ...
                                    <div class="profile-picture profile-picture--style-2">
                                        <center>
                                            <?php
                                                ...
                                                ?>
                                                    <div class="home_pm lazy-load" data-background="<?=base_url()?>uploads/profile_image/default.jpg"></div>
                                                <?php }else{ ?>
                                                    <div class="home_pm lazy-load" data-background="<?=base_url()?>uploads/profile_image/<?=$premium_member->member_id.'/'.$premium_member->profile_image?>">
                                                    </div>
                                                    <?php } }elseif ($pic_privacy_data[0]['profile_pic_show']=='premium' and $is_premium>=2) {
                                                    ?>
                                                        <div class="home_pm lazy-load" data-background="<?=base_url()?>uploads/profile_image/<?=$premium_member->member_id.'/'.$premium_member->profile_image?>"></div>
...
<script>
    ...
    $(window).on('load', function() {
        ...
        $(".lazy-load").each(function(index, value) {
            
            const ele = $(value);
            const background = ele.data('background');

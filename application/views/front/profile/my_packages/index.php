					...
					<div class="col-sm-12 m-0 p-0">
						<div class="single-prices">
							<div class="price-tags">
								...
								<h2><span>(USD)</span> $15 / <span>Month</span> </h2>
								<img src="../template/front/images/plat.png" alt="" class="img-fluid">
								...
								<div class="flex-fill">
									<div class="price-items text-center">
										...
										<div class="form-checks">
											...
											<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked> $15 every 3 months
											</label><br>
											<label class="form-check-labels">
												<input class="form-check-input" type="radio" name="billingType"  value="2"> $30 every 6 months
											</label><br>
											<label class="form-check-labels">
												<input class="form-check-input" type="radio" name="billingType" value="3"> $60 every 12 months </label>
										</div>
					...
					<div class="col-sm-6 m-0 p-0">
						...
						<div class="single-prices">
							<div class="price-tags">
								...
								<?php } ?>
								<p>Subscription renews automatically every month(s)</p>
							</div>
							<div class="price-items">
								<h4>PLATINUM PACKAGE OFFERS</h4>
								<ol>
									...
									<li>SEND EMOJIS UNLIMITED</li>
									<li>ADD 3-4 PICTURES</li>
									<li>RECEIVE E-MAILS WHEN INTEREST IS SHOWN</li>
									<li>VIEW NEW MESSAGES</li>
									<li>SAVE INTERESTING PROFILES</li>
								</ol>
							</div>
							...
							<div class="flex-fill">
								<div class="single-prices">
									<div class="price-tags">
										...
										<?php } ?>
										<p>Subscription renewed every <br> month(s) thereafter</p>
									</div>
									<div class="price-items p-1">

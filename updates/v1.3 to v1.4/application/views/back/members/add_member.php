		    ...
		    <div class="panel-body">
	    		<form class="form-horizontal" id="manage_details_form" method="POST" action="<?=base_url()?>admin/members/add_member/do_add">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" value="<?php if(!empty($form_contents)){echo $form_contents['fname'];}?>" name="fname" placeholder="<?= translate('first_name')?>" required="">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" value="<?php if(!empty($form_contents)){echo $form_contents['mobile'];}?>" class="form-control" name="mobile"  placeholder=" <?= translate('mobile_no.')?>">
						</div>
					</div>
					<div class="form-group">

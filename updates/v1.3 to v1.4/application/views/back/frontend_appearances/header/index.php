		...
		<div class="panel">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="general_settings_form" method="POST" action="<?=base_url()?>admin/save_frontend_settings/update_header" enctype="multipart/form-data">
					...
					<!-- <div class="form-group">
						<label class="col-sm-3 control-label" for="sticky_header"><b>Sticky Header</b></label>
						<div class="col-sm-6">
							<select class="form-control" name="sticky_header">
					            <option value="left">Yes</option>
					            <option value="right" selected>No</option>
					        </select>
						</div>
					</div> -->
					<div class="form-group">
